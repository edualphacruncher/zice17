...
int main( int argc, const char ** argv ){
        ...
        if ( (strcmp(argv[1],"-version") == 0) || (strcmp(argv[1],"-v") == 0) || (strcmp(argv[1],"-info") == 0) ){
                ...
                cout << "                        license " << TasmanianSparseGrid::getLicense() << endl << endl;
                return 0;
        }
                ...
                if ( (strcmp(argv[k],"--help") == 0)||(strcmp(argv[k],"-help") == 0)||(strcmp(argv[k],"-h") == 0)||(strcmp(argv[k],"help") == 0) ){
                        ...
                        if ( k+1 < argc ){
                                ...
                                if ( strcmp(argv[k], "level" ) == 0 ){
                                        wrap.setDepthType( type_level );
                                }else if ( strcmp(argv[k], "curved" ) == 0 ){
                                        wrap.setDepthType( type_curved );
                                }else if ( strcmp(argv[k], "iptotal" ) == 0 ){
                                        wrap.setDepthType( type_iptotal );
                                }else if ( strcmp(argv[k], "ipcurved" ) == 0 ){
                                        wrap.setDepthType( type_ipcurved );
                                }else if ( strcmp(argv[k], "qptotal" ) == 0 ){
                                        wrap.setDepthType( type_qptotal );
                                }else if ( strcmp(argv[k], "qpcurved" ) == 0 ){
                                        wrap.setDepthType( type_qpcurved );
                                }else if ( strcmp(argv[k], "hyperbolic" ) == 0 ){
                                        wrap.setDepthType( type_hyperbolic );
                                }else if ( strcmp(argv[k], "iphyperbolic" ) == 0 ){
                                        wrap.setDepthType( type_iphyperbolic );
                                }else if ( strcmp(argv[k], "qphyperbolic" ) == 0 ){
                                        wrap.setDepthType( type_qphyperbolic );
                                }else if ( strcmp(argv[k], "tensor" ) == 0 ){
                                        wrap.setDepthType( type_tensor );
                                }else if ( strcmp(argv[k], "iptensor" ) == 0 ){
                                        wrap.setDepthType( type_iptensor );
                                }else if ( strcmp(argv[k], "qptensor" ) == 0 ){
                                        wrap.setDepthType( type_qptensor );
                                }else{
                        ...
                        if ( k+1 < argc ){
                                ...
                                if ( strcmp(argv[k], "classic" ) == 0 ){
                                        wrap.setTypeRefinement( refine_classic );
                                }else if ( strcmp(argv[k], "parents" ) == 0 ){
                                        wrap.setTypeRefinement( refine_parents_first );
                                }else if ( strcmp(argv[k], "direction" ) == 0 ){
                                        wrap.setTypeRefinement( refine_direction_selective );
                                }else if ( strcmp(argv[k], "fds" ) == 0 ){
                                        wrap.setTypeRefinement( refine_fds );
                                }else{
