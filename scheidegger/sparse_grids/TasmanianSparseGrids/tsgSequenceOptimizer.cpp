...
double GreedySequences::getMinLebesgueStored( int i ) const{
        switch( i ){
                ...
                default : cerr << "ERROR: GreedySequences::getMinLebesgueStored called with wrong i, how did this happen?" << endl; return 0.0;
        }
}
...
double GreedySequences::getMinDeltaStored( int i ) const{
        switch( i ){
                ...
                default : cerr << "ERROR: GreedySequences::getMinDeltaStored called with wrong i, how did this happen?" << endl; return 0.0;
        }
}
