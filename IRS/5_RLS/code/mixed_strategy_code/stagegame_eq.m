...
%fprintf('stage=%i boundary_val1 v1(c,c1,c) (%g,%g,%g)=%g h1cc1c=%g sp=%g\n',stage,c,c1,c,boundary_val1,h1cc1c,sp);

  iv_profit2=-k+bet*(h1cc1c+sp*boundary_val1);
%fprintf('high cost firm 2 profit from investing: %g\n',iv_profit2);
  ni_profit2=bet*h1c2c1c/(1-bet*sp);
%fprintf('high cost firm 2 h1c2c1c=%g profit from not investing: %g\n',h1c2c1c,ni_profit2);
  ...
  iv_profit1_gain=iv_profit1-ni_profit1;
%fprintf('stage=%i boundary_val v1(c,c2,c) (%g,%g,%g)=%g h1cc2c=%g sp=%g\n',stage,c,c1,c,boundary_val,h1cc2c,sp);
%fprintf('low cost firm 1 profit from investing: %g\n',iv_profit1);
%fprintf('low cost firm 1 h1c1c2c=%g profit from not investing: %g\n',h1c1c2c,ni_profit1);
