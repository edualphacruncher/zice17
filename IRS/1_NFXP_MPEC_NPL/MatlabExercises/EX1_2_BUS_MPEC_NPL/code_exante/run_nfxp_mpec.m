...
% Swiches:
MonteCarlo = 0;   % 1: Do monte Carlo, 0: Use rust bus data 
...
% Structural parameters for Monte Carlo
...
if MonteCarlo     % Solve model for DGP
	...
	N = 500;		  % Number of busses to simulate 
...
for i_mc = 1:nMC;
	...
	mpec_results.converged(i_mc) = (EXITFLAG >= 1 & EXITFLAG <= 3);
	mpec_results.llval(i_mc)     = -FVAL*samplesize;
