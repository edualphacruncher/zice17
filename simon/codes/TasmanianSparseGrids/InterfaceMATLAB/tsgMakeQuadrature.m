function [ weights, points ] = tsgMakeQuadrature( iDim, s1D, sType, iDepth, iOrder, mTransformAB, vAlphaBeta, vAnisotropy, lCustomRule )
%
...
%                       constructed by integrating the interpolant)
%            Note: local rules ignore the values of inputs sType, vAnisotropy
%                  and vAlphaBeta
%
